...
object SqlQueryEnrichmentCfLineSpec {
  ...
  // TODO: change this when Schema will be merged: https://github.com/snowplow/iglu-central/pull/349
  def schemaPublished = false
}
...
class SqlQueryEnrichmentCfLineSpec extends Specification {
  ...
  if (SqlQueryEnrichmentCfLineSpec.continuousIntegration && SqlQueryEnrichmentCfLineSpec.schemaPublished) {
